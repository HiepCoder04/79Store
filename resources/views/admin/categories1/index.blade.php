...
<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center">
    ...
    <a href="{{ route('categories.create') }}" class="btn btn-primary btn-sm">+ Thêm danh mục</a>
  </div>
        ...
        <tr>
          ...
          <td>
            ...
            <form action="{{ route('categories.destroy', $cat) }}" method="POST" style="display:inline-block;">
              @csrf
              @method('DELETE')
              <button type="submit" onclick="return confirm('Xoá danh mục này?')" class="btn btn-sm btn-danger">Xoá</button>
            </form>
          </td>
        </tr>
        @endforeach

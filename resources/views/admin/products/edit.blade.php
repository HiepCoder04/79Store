                    ...
                    <div class="variant border rounded p-3 position-relative mb-3">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="variants[{{ $vIndex }}][height]" value="{{ old("variants.$vIndex.height", $variant->height) }}" class="form-control" placeholder="VD: 20 / 30 / 40">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Giá (VNĐ)</label>
                                <input type="number" name="variants[{{ $vIndex }}][price]" value="{{ old("variants.$vIndex.price", $variant->price) }}" class="form-control" min="0" step="1000" placeholder="VD: 120000">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Số lượng tồn</label>
                                <input type="number" name="variants[{{ $vIndex }}][stock_quantity]" value="{{ old("variants.$vIndex.stock_quantity", $variant->stock_quantity) }}" class="form-control" min="0" step="1" placeholder="VD: 50">
                            </div>
                        </div>
                    </div>
                    @php $vIndex++; @endphp
                        ...
                        @foreach($pots as $pot)
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="form-check d-flex align-items-start shadow-sm border rounded p-3 h-100">
                                    <input class="form-check-input mt-1 me-2" type="checkbox" name="selected_pots[]" value="{{ $pot->id }}"
...
<script>
    ...
    // ===== Basic Client Validation (optional cho UX) =====

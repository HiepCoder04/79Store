...
<p class="post-excerpt">
    ...
    <a href="{{ route('client.blogs.show', $blog->slug) }}" class="text-success">Đọc thêm</a>
</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-12 text-center mb-100">
                <a href="{{ route('client.blogs.index') }}" class="btn alazea-btn" title="Xem tất cả tin tức">Xem tất cả bài viết</a>

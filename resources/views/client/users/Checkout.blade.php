...
<script>
    document.addEventListener('DOMContentLoaded', function() {
            ...
            if (localStorage.getItem('tempNewAddress')) {
                ...
                if (savedAddress && newAddressInput) {
                    ...
                    if (addressDisplayContainer) {
                        ...
                        const addressText = addressDisplayContainer.querySelector('.fa-location-dot').nextSibling;
                        if (addressText) {
        ...
        if (confirmNewAddressBtn && newAddressInput) {
            confirmNewAddressBtn.addEventListener('click', function() {
                ...
                if (newAddress) {
                    ...
                    localStorage.setItem('tempSetDefault', document.getElementById('set_default').checked ? '1' : '0');
                } else {
                    // Show error if empty
        ...
        const logFormData = () => {
            ...
            // Address info
            if (document.getElementById('new_address') && document.getElementById('new_address').value.trim()) {
        ...
        if (placeOrderBtn) {
            placeOrderBtn.addEventListener('click', function() {
                ...
                if (methodOnline && methodOnline.checked) {
                    ...
                    document.getElementById('vnpay-phone').value = document.getElementById('phone').value;
                    ...
                    if (document.getElementById('set_default')) {
                        document.getElementById('vnpay-set_default').value = document.getElementById('set_default').checked ? 1 : 0;
                    }
    
                    // Copy note if applicable
                    if (document.getElementById('note')) {
                        document.getElementById('vnpay-note').value = document.getElementById('note').value;
                    }

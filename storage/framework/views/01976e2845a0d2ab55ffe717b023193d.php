<footer class="footer-area bg-img" style="background-image: url('<?php echo e(asset('img/bg-img/3.jpg')); ?>');">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-footer-widget">
                        <div class="footer-logo mb-30">
                            <a href="#"><img src="<?php echo e(asset('assets/img/core-img/leaf.png')); ?>" alt="Logo cửa hàng"></a>
                        </div>
...
<div class="col-12 col-sm-6 col-lg-3">
    <div class="single-footer-widget">
        ...
        <?php if(isset($bestSellers) && $bestSellers->count()): ?>
           <?php $__currentLoopData = $bestSellers->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                <?php
                ...
                <div class="single-best-seller-product d-flex align-items-center">
                    <div class="product-thumbnail">
                        <a href="<?php echo e(route('shop-detail', $product->id)); ?>">
                            <img src="<?php echo e($imagePath); ?>" alt="<?php echo e($product->name); ?>" class="footer-best-thumb">
                        </a>
                    </div>
                    <div class="product-info">
                        <a href="<?php echo e(route('shop-detail', $product->id)); ?>"><?php echo e($product->name); ?></a>
...
<?php /**PATH C:\laragon\www\79Store\79Store\resources\views/client/layouts/footer.blade.php ENDPATH**/ ?>
            ...
            <div class="row">
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>"><i class="fa fa-home"></i> Trang chủ</a></li>
        ...
        <div class="container">
            ...
            <?php else: ?>
                                        ...
                                        <tr data-item-id="<?php echo e($item->id); ?>">
                                            <td>
                                                <input type="checkbox"
                                                    ...
                                                    class="item-checkbox"
                                                    <?php if($item->out_of_stock): ?> disabled <?php endif; ?>>
                                            </td>
                                            <td class="text-start">
                                                <div class="d-flex align-items-center gap-3">
                                                    <img src="<?php echo e($imageUrl); ?>" alt="<?php echo e($product->name); ?>" width="80" class="img-thumbnail">
                                                    <strong><?php echo e($product->name); ?></strong>
                                                     <?php if($item->out_of_stock): ?>
                                                        <div class="text-danger small"><?php echo e($item->out_of_stock_message); ?></div>
                                                    <?php endif; ?>
                                                </div>
                                            </td>
                                            
                                            <td><?php echo e($item->pot?->name ?? 'Không có chậu'); ?>

                                                
                                            </td>
                                            
                                            <td><?php echo e($variant->height ? $variant->height . ' cm' : 'Không rõ'); ?></td>
                                            ...
                                            <td><?php echo e(number_format($productPrice, 0, ',', '.')); ?>đ</td>

                                            
                                            <td><?php echo e($potPrice > 0 ? number_format($potPrice, 0, ',', '.') . 'đ' : '0đ'); ?></td>

                                            
                                            <td class="item-subtotal">
                                                <?php echo e(number_format(($productPrice + $potPrice) * $item->quantity, 0, ',', '.')); ?>đ
                                            </td>
                ...
                <div class="row">
                    ...
                    <form id="apply-voucher-form" action="<?php echo e(route('apply.voucher')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="cart-totals-area mt-70">
                            ...
                            <div class="subtotal d-flex justify-content-between">
                                <h5>Tạm tính</h5>
                                <h5 id="subtotal-value"><?php echo e(number_format($cartTotal, 0, ',', '.')); ?>đ</h5> 
                            </div>
                            ...
                            <?php if($voucher): ?>
                                <div class="discount d-flex justify-content-between">
                                    <h5>Mã giảm: <?php echo e($voucher->code); ?></h5>
                                    <h5 class="text-danger">-<?php echo e(number_format($discount, 0, ',', '.')); ?>đ</h5>
                                </div>
                            <?php endif; ?>

                            <div class="total d-flex justify-content-between mt-3">
                                <h5>Tổng cộng</h5>
                                <h5 id="total-value"><?php echo e(number_format($finalTotal, 0, ',', '.')); ?>đ</h5>
                            </div>

                            <form id="checkout-form-selected" action="<?php echo e(route('checkout.index')); ?>" method="GET">
...
<?php echo $__env->make('client.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\79Store\79Store\resources\views/client/users/cart.blade.php ENDPATH**/ ?>
...
<?php if($typeClass && $message): ?>
    <div id="alertBox" class="custom-alert alert-<?php echo e($typeClass); ?>" role="alert">
        <div class="custom-alert-content">
            <div class="progress-circle-wrapper <?php echo e($typeClass); ?>">
                ...
                <i
                    class="
                    <?php if($typeClass === 'success'): ?> bi bi-check-lg
                    <?php elseif($typeClass === 'danger'): ?> bi bi-x-lg
                    <?php elseif($typeClass === 'warning'): ?> bi bi-exclamation-lg <?php endif; ?>
            ...
            <span class="<?php echo e($mauchu); ?>"><?php echo e($message); ?></span>
...
<?php endif; ?> -->
<?php /**PATH C:\laragon\www\79Store\79Store\resources\views/client/layouts/thongbao.blade.php ENDPATH**/ ?>
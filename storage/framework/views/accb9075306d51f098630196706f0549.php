    ...
    <div id="chatbot-container" class="chatbot-container">
        ...
        <div class="chatbot-header">
            <div class="chatbot-header-info">
                <img src="<?php echo e(asset('assets/img/core-img/leaf.png')); ?>" alt="79Store" class="chatbot-avatar">
                <div>
        ...
        <div id="chatbot-messages" class="chatbot-messages">
            <div class="message bot-message">
                <div class="message-avatar">
                    <img src="<?php echo e(asset('assets/img/core-img/leaf.png')); ?>" alt="Bot">
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function sendMessage(message) {
        ...
        // Send to server
        fetch('<?php echo e(route("chatbot.chat")); ?>', {
            method: 'POST',
            headers: {
    ...
    function addMessage(message, sender) {
        ...
        if (sender === 'bot') {
            avatarDiv.innerHTML = '<img src="<?php echo e(asset("assets/img/core-img/leaf.png")); ?>" alt="Bot">';
        } else {
            avatarDiv.innerHTML = '<img src="<?php echo e(asset("assets/img/core-img/user-avatar.png")); ?>" alt="User" onerror="this.style.display=\'none\'">';
        }
...
<?php /**PATH C:\laragon\www\79Store\79Store\resources\views/client/layouts/chatbot.blade.php ENDPATH**/ ?>
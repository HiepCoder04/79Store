                ...
                <div class="testimonials-slides owl-carousel">
                        ...
                        <div class="row align-items-center">
                            <div class="col-12 col-md-6">
                                <div class="testimonial-thumb">
                                    <img src="<?php echo e(asset('assets/img/bg-img/13.jpg')); ?>" alt="">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                    ...
                    <div class="single-testimonial-slide">
                        <div class="row align-items-center">
                            <div class="col-12 col-md-6">
                                <div class="testimonial-thumb">
                                    <img src="<?php echo e(asset('assets/img/bg-img/14.jpg')); ?>" alt="Khách hàng X">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="testimonial-content">
                    ...
                    <div class="single-testimonial-slide">
                        <div class="row align-items-center">
                            <div class="col-12 col-md-6">
                                <div class="testimonial-thumb">
                                    <img src="<?php echo e(asset('assets/img/bg-img/15.jpg')); ?>" alt="">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="testimonial-content">
...
<?php /**PATH C:\laragon\www\79Store\79Store\resources\views/client/layouts/testimonial.blade.php ENDPATH**/ ?>
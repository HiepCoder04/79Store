                    ...
                    <div class="top-header-content d-flex align-items-center justify-content-between">
                        ...
                        <div class="top-header-meta d-flex align-items-center gap-3">
                            ...
                            <div class="top-header-right d-flex align-items-center justify-content-end gap-1">
                                ...
                                <?php if(Auth::check()): ?>
                                    <div class="user-dropdown">
                                        <a href="#" class="user-toggle">
                                            ...
                                            <?php if(Auth::user()->avatar): ?>
                                                <img id="header-avatar"
                                                    src="<?php echo e(asset('img/avatars/' . Auth::user()->avatar)); ?>"
                                                    alt="Avatar"
                                        ...
                                        <ul class="user-dropdown-menu">
                                            <li>
                                                <a href="<?php echo e(route('client.account.index')); ?>">
                                                     Tài khoản của tôi
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(route('client.orders.index')); ?>">
                                                     Đơn hàng
                                                </a>
                                            </li>
                                            <li>
                                                ...
                                                <form id="logout-form" action="<?php echo e(route('auth.logout')); ?>"
                                ...
                                <!-- Giỏ hàng -->
                                <div class="cart ml-3">
                                    <a href="<?php echo e(route('cart.index')); ?>" id="cart-icon">
                                        <i class="fa fa-shopping-cart"></i>
                                        <span>Giỏ hàng <span id="cart-count">(<?php echo e($cartItemCount ?? 0); ?>)</span></span>
                                    </a>
                                </div>
            ...
            <div class="container">
                <nav class="classy-navbar justify-content-between" id="alazeaNav">
                    ...
                    <a href="<?php echo e(route('home')); ?>" class="nav-brand">
                        <img src="<?php echo e(asset('assets/img/core-img/leaf.png')); ?>" alt="79Store Logo"
                            style="height: 50px;">
                    </a>
                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            <ul>
                                ...
                                <li><a href="<?php echo e(route('shop')); ?>">Sản phẩm</a></li>
                                <li><a href="<?php echo e(route('client.blogs.index')); ?>">Tin tức</a></li>
                                <li><a href="<?php echo e(route('cart.index')); ?>">Giỏ hàng</a></li>
                                <li><a href="<?php echo e(route('client.contact.form')); ?>">Liên hệ</a></li>
...
<div class="search-form">
  <div id="searchWrap" class="search-wrap">
    <form action="<?php echo e(route('shop')); ?>" method="GET" onsubmit="return gotoFirstResult(event)">
      <input
        id="searchInput"
        type="search"
        name="keyword"
        ...
        autocomplete="off"
        data-url="<?php echo e(route('search.suggest')); ?>"
      >
    </form>
...
(function(){
  ...
  const DETAIL_PREFIX_BY_SLUG = "<?php echo e(url('/shopDetail')); ?>";
...
<?php echo $__env->make('client.layouts.thongbao', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH C:\laragon\www\79Store\79Store\resources\views/client/layouts/header.blade.php ENDPATH**/ ?>